...
2. Read that agent's current definition at `C:\Agents\[agent]\brain\persona.md` and `knowledge\`
3. Determine what rule or knowledge file was missing that would have prevented this bug
4. Write a new knowledge file to `C:\Agents\[agent]\knowledge\[descriptive-name].md`:
